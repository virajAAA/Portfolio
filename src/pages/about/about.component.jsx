          ...
          <Row className="pt-3 pb-5 align-items-center">
            ...
            <Col xs={12} md={6}>
              <Row className=" align-items-start p-2 my-details rounded">
                ...
                <br />A passionate programmer, born and brought up in Ahmednagar, India. I am a Web Developer with HTML, CSS, JavaScript, and React-Js.
                <br />
                In 2017, I successfully completed my Masters with a specialization in 'Computer Science'.               <br />
                
                Currently working as a FreeLancer Web Developer. 
                <br />
                I have 2 years of experience in Web Development. My goal is always to provide the amazing and best level of quality, service to the client.
